...
<x-tablelistAluno :header="['Nome','E-mail','Curso', 'Disciplina','Eventos']" :data="$aluno"/>
        ...
        function getLin(aluno){
            ...
            "<tr style='text-align: center'>" +
                ...
                "<td>" +
                    ...
                    "<a class='btn' style='cursor: pointer' href='{{route('matricula.show', $item->id)}})}}'><i class='fa fa-arrow-up'></i></a>" +
