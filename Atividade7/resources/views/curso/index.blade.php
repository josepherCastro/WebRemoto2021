...
<x-tablelistCurso :header="['Nome', 'Eventos']" :data="$curso"/>
    ...
    <script type="text/javascript">
        ...
        function getLin(curso){
            ...
            "<tr style='text-align: center'>" +
                "<td>" + curso.nome + "</td>" +
                "<td>" +
                    "<a class='btn' nohref style='cursor:pointer' onCLick='visualizar("+ curso.id +")'><i class='fa fa-question'></i></a>" +
                    "<a class='btn' nohref style='cursor:pointer' onCLick='editar("+ curso.id +")'><i class='fa fa-pencil-square-o'></i></a>" + 
                    "<a class='btn' nohref style='cursor:pointer' onCLick='remover("+ curso.id +")'><i class='fa fa-trash-o'></i></a>" +
                "</td>" +
            "</tr>";
            return linha;
        }
