...
<x-tablelistProfessor :header="['Nome','E-mail','Eventos']" :data="$professor"/>
    ...
    <script type="text/javascript">
        ...
        function getLin(professor){
            ...
            "<tr style='text-align: center'>" +
                ...
                "<td>" +   
                    "<a class='btn' nohref style='cursor:pointer' onCLick='visualizar("+ professor.id +")'><i class='fa fa-question'></i></a>" +              
                    "<a class='btn' nohref style='cursor:pointer' onCLick='editar("+ professor.id +")'><fa fa-pencil-square-o'></i></a>" + 
                    "<a class='btn' nohref style='cursor:pointer' onCLick='remover("+ professor.id +")'><i class='fa fa-trash-o'></i></a>" +
                "</td>" +
            "</tr>";
            return linha;
        }
