    ...
    <div class="d-flex justify-content-center"> 
        <div class="item-menu" style="margin-right: 100px;">
            <a href="{{ route('curso.index') }}">
                <img src="{{ asset('img/curso_ico.png') }}" style="width: 150px;">
        ...
        <div class="item-menu" style="margin-right: 100px;">
            <a href="{{ route('disciplina.index') }}">
                <img src="{{ asset('img/componente_ico.png') }}" style="width: 150px;">
        ...
        <div class="item-menu" style="margin-right: 100px;">
            <a href="{{ route('professor.index') }}">
                <img src="{{ asset('img/professor_ico.png') }}" style="width: 150px;">
        ...
        <div class="item-menu">
            <a href="{{ route('aluno.index') }}">
                <img src="{{ asset('img/aluno_ico.png') }}" style="width: 150px;">
